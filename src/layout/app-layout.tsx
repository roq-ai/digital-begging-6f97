...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Beggar', path: '/beggars', entity: 'beggar', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Donor', path: '/donors', entity: 'donor', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    { name: 'Resource', path: '/resources', entity: 'resource', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
